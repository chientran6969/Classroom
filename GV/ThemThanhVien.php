                ...
                if($result->num_rows > 0){
                    ...
                    if(isset($_GET['agree'])){
                        ...
                        if(!$stmt2->execute()){
                            ...
                            $sql4 = "SELECT * from lop where IdLop = ?";
                            $stmt4 = $conn->prepare($sql4);
                            $stmt4->bind_param('i',$IdLop);
                            if(!$stmt4->execute()){
                            ...
                            $t = createToken($email);
                            sendEmailAcceptToStudent($IdLop,$TenLop,$IdNguoiDung,$email,$t['token']);//Sửa địa chỉ của localhost trong hàm này lại (đang là localhost:8080 chỉ chạy được trên máy t)
