...
<body>
    ...
    if (isset($_POST['search']) and $_POST['search'] != '') {
        ...
        $stmt = $conn->prepare("SELECT * from lop Where IdGV = ? and (TenLop like ? or Mon like ? or Phong like ?)");

        $stmt->bind_param("isss",$_SESSION['id'], $s, $s, $s);
        ...
        $sql = "SELECT * FROM Lop where IdGV = ?";
                            ...
                            <div class="row h-100">
                                ...
                                ?>
                                    <div class="col-xs-12 col-md-6 col-xl-4 mb-4 ">
                                        <div class="card h-100" style="width: 20rem; height:21rem;">
                                        ...
                                        <img class="card-img-top" style="max-width: 400px; max-height:180px;" src="<?php echo $row['HinhLop'] ?>" alt="Hinh lop">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text"><strong>Phòng:</strong> <?php echo $row['Phong'] ?></p>
                                                <p class="card-text"><strong>Mã lớp:</strong> <?php echo $row['MaLop'] ?></p>
