                        ...
                        <div class="col-md-5">
                            <div class="card shadow-lg border-0 rounded-lg">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-nomal my-4">Sửa thông báo</h3>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="SuaThongBao.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $row1['ChuDe'] ?>" name="ChuDe" class="form-control py-4" id="inputChuDe" type="text" placeholder="Nhập chủ để" />
                                        </div>
                                        ...
                                        <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button type="submit" class="btn btn-primary m-auto">Sửa thông báo</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
